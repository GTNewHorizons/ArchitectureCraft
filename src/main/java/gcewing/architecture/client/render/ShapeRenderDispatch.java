        ...
        if (te.shape != null && (renderBase || renderSecondary)) {
            ...
            if (base != null) {
                ...
                if (icon != null) {
                    ...
                    if (renderBase) {
                        textures[0] = ArchitectureTexture.fromSpriteAndBlockPlusMeta(icon, base.getBlock(), getMetaFromBlockState(base));
                        textures[0] = checkBlendAndEmissive(base, textures[0]);
                        textures[1] = textures[0].projected();
                    }
                    if (renderSecondary) {
                        if (icon2 != null) {
                            textures[2] = ArchitectureTexture.fromSpriteAndBlockPlusMeta(icon2, te.secondaryBlockState.getBlock(), getMetaFromBlockState(te.secondaryBlockState));
